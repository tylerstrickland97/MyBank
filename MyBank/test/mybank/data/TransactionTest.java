...
public class TransactionTest {
	...
	public void testToString() {
		...
		assertEquals("-902.34,House payment,11/28/2021", t1.toString());
		assertEquals("-102.37,Groceries,12/14/2021", t2.toString());
		assertEquals("-34.67,Sheetz,01/18/2022", t3.toString());
		assertEquals("1045.69,Weekly Deposit,12/01/2021", t4.toString());
		assertEquals("15.83,Refund,10/27/2021", t5.toString());
	}
